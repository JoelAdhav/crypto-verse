...
const HighLowIndiator = ({ currentPrice, high, low }) => {
...
const CryptoDetails = () => {
    ...
    return ReactDOM.createPortal(
        <div
            className='fixed z-20 top-0 w-full h-full bg-gray-200 bg-opacity-30 backdrop-blur-sm flex 
        ...
        >
            ...
            >
                {data ? (
                    <div
                        className='flex md:flex-row flex-col  items-center justify-between lg:h-full h-auto 
                    w-full p-4 relative'
                    >
                        <div className='flex flex-col md:w-[45%] w-full h-full pr-2'>
                            <div className='flex w-full items-center'>
                                ...
                                <span
                                    className='text-sm py-0.5 px-2.5 ml-2 bg-blue text-blue bg-opacity-25 
                                rounded uppercase'
                                >
                                    {data.symbol}
                                </span>
                            ...
                            <div className='flex w-full mt-6'>
                                <div className='flex flex-col w-full'>
                                    <div className='flex justify-between'>
                                        ...
                                        <div
                                            className={`text-sm px-1 ml-2 font-medium flex items-center rounded
                                        uppercase bg-opacity-25 ${
                                            data.market_data
                            ...
                            <div className='flex sm:flex-row flex-colChart w-full justify-between mt-4'>
                                <div className='flex flex-col'>
                                    <a
                                        target={'_blank'}
                                        rel='noreferrer'
                                    ...
                                    >
                                        {data?.links?.homepage[0].substring(
                                            0,
                                            30
                                        )}
                                    </a>
                                    ...
                                    >
                                        {data?.links?.blockchain_site[0].substring(
                                            0,
                                            30
                                        )}
                                    </a>
                                    {data?.links?.official_forum_url[0] ? (
                                        <a
                                            ...
                                            href={
                                                data?.links
                                                    ?.official_forum_url[0]
                                            }
                                        >
                                            {data?.links?.official_forum_url[0].substring(
                                                0,
                                                30
                                            )}
                                        </a>
                                ...
                                <div className='flex flex-col sm:mt-0 mt-1 content-start'>
                                    <span className='text-sm capitalize text-gray-100'>
                                        Sentiment
                                    </span>
                                    <div
                                        className={`text-sm px-1 my-1 ml-2 font-medium flex items-center rounded
                                    ...
                                    <div
                                        className={`text-sm px-1 my-1 ml-2 font-medium flex items-center rounded
                                        uppercase bg-opacity-25 bg-red text-red `}
                                    >
                                        <span>
                                            {Number(
                        ...
                        <div className='flex flex-col md:w-[55%] w-full h-[60vh] md:pl-4 pl-0 md:mt-0 mt-2'>
                            ...
                            <div className='flex flex-col mt-10 sm:ml-2 '>
                        ...
                        <div className='absolute md:bottom-8 bottom-4 right-4 sm:right-8 flex md:flex-row flex-col items-center'>
